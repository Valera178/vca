                   ...
                   <div className="space-y-4">
                      {tasks.map(task => (
                         <div
                           ...
                           className={`group flex items-start focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 gap-4 p-4 rounded-xl border transition-all cursor-pointer ${
                              task.completed

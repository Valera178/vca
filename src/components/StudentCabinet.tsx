                            ...
                            <div className="flex-1">
                               ...
                               {task.fen && !task.completed && (
                                  <div className="mt-3 bg-black/40 rounded-lg p-3 border border-white/5 flex items-center justify-between group-hover:border-emerald-500/20 transition-colors">
                                     ...
                                     <button onClick={(e) => e.stopPropagation()} className="text-xs bg-emerald-500/20 text-emerald-400 px-3 py-1.5 rounded-md font-semibold hover:bg-emerald-500 hover:text-white transition-colors flex items-center gap-1">
                                        Решить

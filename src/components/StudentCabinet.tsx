                   ...
                   <div className="space-y-4">
                      {tasks.map(task => (
                         <div
                           ...
                           aria-label={`Задание: ${task.title}. Статус: ${task.completed ? 'Выполнено' : 'Не выполнено'}`}
                           className={`group flex items-start gap-4 p-4 rounded-xl border transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 ${
                              task.completed

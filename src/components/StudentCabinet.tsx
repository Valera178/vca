                      ...
                      {tasks.map(task => (
                         ...
                         >
                            ...
                            <div className="flex-1">
                               <button
                                  onClick={() => toggleTask(task.id)}
                                  className={`text-left w-full font-medium transition-colors focus-visible:outline-none focus-visible:underline ${task.completed ? 'text-slate-400 line-through' : 'text-slate-200 group-hover:text-white'}`}
                               >
                                  <h3 className="inline">{task.title}</h3>
                               </button>

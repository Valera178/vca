                      ...
                      {tasks.map(task => (
                         ...
                         >
                            <button
                               ...
                               className={`mt-0.5 shrink-0 transition-colors focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:outline-none rounded-full ${
                                  task.completed ? 'text-emerald-500' : 'text-slate-500 group-hover:text-emerald-400'
                               }`}
                            >

                   ...
                   <div className="p-4 border-t border-white/10 bg-black/20 shrink-0 z-10 backdrop-blur-md">
                      <form onSubmit={handleSendMessage} className="relative flex items-center gap-3">
                         ...
                         <button
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-purple-600 hover:bg-purple-500 disabled:bg-slate-700 disabled:text-slate-400 text-white rounded-xl flex items-center justify-center transition-all disabled:opacity-50 shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
                         >

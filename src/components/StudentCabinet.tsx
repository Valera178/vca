                         ...
                         <div
                           ...
                           className={`group flex items-start gap-4 p-4 rounded-xl border transition-all cursor-pointer ${
                              task.completed
                                 ...
                                 : 'bg-white/5 border-white/10 hover:bg-white/10 hover:border-emerald-500/30 focus:outline-none focus:ring-2 focus:ring-emerald-500/50'
                           }`}
                         >
                               ...
                               {task.fen && !task.completed && (
                                  <div className="mt-3 bg-black/40 rounded-lg p-3 border border-white/5 flex items-center justify-between group-hover:border-emerald-500/20 transition-colors">
                                     ...
                                     <button
                                        ...
                                        className="text-xs bg-emerald-500/20 text-emerald-400 px-3 py-1.5 rounded-md font-semibold hover:bg-emerald-500 hover:text-white transition-colors flex items-center gap-1 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                                     >
                                        Решить
                   ...
                   <div className="p-4 border-t border-white/10 bg-black/20 shrink-0 z-10 backdrop-blur-md">
                      <form onSubmit={handleSendMessage} className="relative flex items-center gap-3">
                         ...
                         <button
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-purple-600 hover:bg-purple-500 disabled:bg-slate-700 disabled:text-slate-400 text-white rounded-xl flex items-center justify-center transition-all disabled:opacity-50 shadow-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                         >
